...
@router.post("/project_type", status_code=status.HTTP_201_CREATED, dependencies=[Depends(validate_api_key)])
...
@router.get("/project_type", response_model=List[ProjectType])
...
@router.delete("/project_type/{type_id}", status_code=status.HTTP_204_NO_CONTENT,
