...
@router.post("/difficulty_level", status_code=status.HTTP_201_CREATED, dependencies=[Depends(validate_api_key)])
...
@router.get("/difficulty_level", response_model=List[DifficultyLevel])
...
@router.delete("/difficulty_level/{level_id}", status_code=status.HTTP_204_NO_CONTENT,
